...
--recipes
require("__planet-signus__.prototypes.items.resources_recipe")

--entities
require("__planet-signus__.prototypes.entity.ores")
--other
require("__planet-signus__.prototypes.technology")
